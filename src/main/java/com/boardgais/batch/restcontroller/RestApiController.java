package com.boardgais.batch.restcontroller;
...
import com.boardgais.batch.repository.RestApiRepository;
import com.boardgais.batch.util.CustomErrorType;
...
public class RestApiController {
    ...
    @Autowired
    RestApiRepository userService; //Service which will do all data retrieval/manipulation work
